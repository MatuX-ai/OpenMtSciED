...
export async function GET() {
  try {
    ...
    const avgRelevance = totalAssociations > 0 
      ? associations.reduce((sum: number, a: any) => sum + (a.relevance_score || 0), 0) / totalAssociations
      : 0;
